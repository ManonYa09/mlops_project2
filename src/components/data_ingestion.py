...
## Define path for saving , train, test, and raw data
## using dataclass for these config step
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv('/Users/macbook/Desktop/MLOPS/mlops_project/notebook/data/stud.csv')
